...
$result = mysqli_query($con,"SELECT message,status,report_time,latitude,longitude,report_date FROM report where MONTH(report_date) = MONTH(CURDATE()) AND YEAR(report_date) = YEAR(CURDATE())AND  (report_date>=CURDATE())");
